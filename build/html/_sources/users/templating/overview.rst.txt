...
.. note::
    Pour proposer autant de fonctionnalités, RaspiSMS utilise le moteur de templating libre Twig (version 3.x). Si vous souhaitez aller encore plus loin avec le moteur de templating de RaspiSMS, nous vous invitons à vous reporter à `la documentation de Twig`_. Vous y trouverez de nombreuses informations.
...
Pour en apprendre plus sur chacune de ces fonctions, consultez `la page des fonctions de la documentation de Twig`_. 
